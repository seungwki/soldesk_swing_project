...
public class UIUtil {
	...
	public static JButton createStyledButton(String text, boolean selected) {
		...
		btn.setFont(new Font("Noto Sans KR", Font.BOLD, 28));
	...
	public static void applySelected(JButton b, boolean selected) {
		...
		if (selected) {
			...
			b.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(mainBlue, 2), BorderFactory.createEmptyBorder(topPad, leftPad, 0, 0)));
		}
		b.repaint();
	}
